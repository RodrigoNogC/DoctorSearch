document.addEventListener('DOMContentLoaded', () => {
    ...
    //const apiBase = 'https://projeto-integrado-avaliacao.azurewebsites.net/projeto4/fecaf';

    async function fetchMedicos() {
        try {
            const response = await fetch(`//projeto-integrado-avaliacao.azurewebsites.net/projeto4/fecaf/listar/medicos`);
